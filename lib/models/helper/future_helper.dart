...
/// Will show a circular progress indicator while waiting for data to be fetched. Then will show child.
...
FutureBuilder waitWhileQuerying<T>({required Future<T> future, required Widget Function(T data) child}) {
